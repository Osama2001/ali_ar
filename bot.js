...
client.on('message', message => {
  ...
  const verifed = ["436960038935068672"];
 ...
 `)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
   message.channel.sendEmbed(embed)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
    ...
    if(message.content.startsWith(prefix + "server")) {
        if(!message.member.hasPermission("MANAGE_MESSAGES")) return message.channel.send("**ليس لديك البرمشن المطلوب لاستخدام هذا الامر ❌**");
...
=========================
الاوامر الادارية
€bc ⇏ لأ ارسال رساله من خيلاال البوت
€clear ⇏ لامسح الشات مع العدد
€ban⇏ لإ عطاء الشخ باند
€kick⇏ لإ اطاء الشخص كيك
